...
| **In review** | **WF02 — North-Star Scale & Aesthetic Calibration** | Presentation-only building scale (~1.3–1.47×), citizen visual height 2.32 m, bounds-anchored dressing, camera reframing, street-life/plaza composition, warmer palette. Simulation authority unchanged. Gate before M03. |
