...
| **In review** | **WF01 — Riverside World Foundation** | Expanded ~240 m town with Kenney prefab buildings, instanced road network, districts (civic/residential/commercial/industrial/farm/river), and landscaping framing. M02 citizen route preserved. Mandatory gate before M03. |
| **In review (R10 STOP)** | **WF02 — North-Star Scale & Aesthetic Calibration** | R10 Phases A–C on R9 foundation: vocabulary audit, facade-bound street portal camera, district composition (civic enclosure, commercial frontage, residential gardens, future-lot frame). Registered Kenney/Quaternius only. Legacy 240 m skeleton preserved behind rollback flag. Awaiting Grok review @ R10 handoff SHA `8923425`. |
